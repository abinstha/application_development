<%-- 
    Document   : example
    Created on : Dec 16, 2019, 6:49:34 PM
    Author     : acer
--%>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="${pageContext.request.contextPath}/CategoryController?act=list">View all Categories</a>
            <a class="collapse-item" href="admin/product_category/create.jsp">Create Category</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
